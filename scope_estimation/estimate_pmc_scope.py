...
Run: python3 scope_estimation/estimate_pmc_scope.py
     (needs only stdlib + network; ~1 min)
"""
...
ROOT = HERE.parent
POS_CSV = ROOT / "pkdb-api" / "pmid_to_pmcid.csv"
OUTPUT = HERE / "pmc_scope_estimate.json"
